...
-fix order first, then pick color scheme
-consider sequential or diverging color scheme
factor type by another variable
- only really seeing the correlation between the last two variables
