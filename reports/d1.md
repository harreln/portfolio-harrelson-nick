...
The continents are reordered based on the average wine price within each continent. Placing the most expensive at the top allows the reader to intuitively interpret the plot (Robbins, 2013a, 161).
...
Thoutt Z (2019) WineMag Reviews Dataset. <https://www.kaggle.com/zynicide/wine-reviews>
